...
const FEATURES = [
  {
    ...
    description: 'Upload any PDF resume and Claude extracts every skill, certification, and experience — with proficiency calibration and career trajectory analysis.',
    gradient: 'from-violet-500 to-purple-600',
  },
  {
    icon: Search,
    title: 'Semantic Search',
    description: 'Type "senior React dev with fintech experience in Mumbai" and get ranked candidates with reasoning, match scores, and gap analysis.',
  ...
  },
  {
    ...
    description: 'Every search returns a 0–100 match score with specific evidence, strengths, gaps, and role recommendations powered by Claude.',
...
const HOW_IT_WORKS = [
  {
    ...
    description: 'Employees upload their PDFs. Claude parses every detail — skills, experience, certifications, and career trajectory.',
    icon: FileText,
  },
  {
    step: '02',
    title: 'Search with AI',
    description: 'HR types any natural language query. Claude semantically ranks candidates with match scores and detailed reasoning.',
    icon: Sparkles,
  },
  {
    step: '03',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <Link
                href="/signup"
                className="text-sm bg-violet-600 hover:bg-violet-500 text-white px-3 sm:px-4 py-2 rounded-lg transition-colors font-medium shadow-glow-sm"
              >
                Get started
              </Link>
            </div>
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <Link
              href="/signup"
              className="w-full sm:w-auto group inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-white transition-all shadow-glow-md"
            ...
            <div className="p-4 sm:p-6 space-y-4 bg-background/50">
              <div className="flex items-center gap-3">
                <div className="flex-1 h-9 rounded-lg bg-secondary border border-border flex items-center px-3 gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-muted-foreground/50 truncate">Senior React developer with AWS and fintech experience...</span>
                </div>
                <div className="h-9 px-3 sm:px-4 rounded-lg flex items-center text-xs font-medium text-white shrink-0"
                  style={{ background: 'linear-gradient(135deg, #7c3aed, #4f46e5)' }}>
                ...
                {[
                  ...
                  <div key={i} className="p-3 rounded-xl border border-border bg-secondary/20 space-y-2">
                    ...
                    <div className="h-1 rounded-full bg-muted">
                      <div className="h-full rounded-full bg-gradient-to-r from-violet-500 to-indigo-500" style={{ width: `${c.score}%` }} />
                    </div>
            ...
            <motion.div variants={fadeUp}>
              <div className="rounded-2xl p-6 sm:p-8 border border-border bg-card text-center">
                ...
                <div className="flex items-center justify-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-violet-500/20 flex items-center justify-center text-xs font-bold text-violet-600 dark:text-violet-300">SM</div>
                  <div>
          ...
          <AnimatedSection>
            <motion.div variants={fadeUp} className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                <Link
                  href="/signup"
                  className="w-full sm:w-auto group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold text-base text-white transition-all shadow-glow-md hover:shadow-glow-lg"
                  style={{ background: 'linear-gradient(135deg, #7c3aed, #4f46e5)' }}
                >
