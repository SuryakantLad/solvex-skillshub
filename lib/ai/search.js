/**
 * lib/ai/search.js
 * Gemini-powered semantic search engine for TalentGraph AI.
 *
 * Architecture:
 *  1. MongoDB pre-filter (hard constraints: department, experience range, availability)
 *  2. Gemini semantic ranking with match reasoning
...
/**
 * Rank a list of employee documents against a natural language query using Gemini.
 *
 * @param {string} query
...
/**
 * Build the optimal team for a project requirement using Gemini.
 *
...
// ─── Quick keyword pre-score (used in chat search to avoid extra Gemini call) ─
